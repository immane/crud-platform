...
#[ORM\Entity(repositoryClass: PaymentOutboxMessageRepository::class)]
#[ORM\Table(name: 'payment_outbox_message')]
#[ORM\UniqueConstraint(name: 'uniq_payment_outbox_event_id', columns: ['event_id'])]
#[ORM\Index(name: 'idx_payment_outbox_unpublished_available', columns: ['published_at', 'available_at'])]
class PaymentOutboxMessage
{
    ...
    public function __construct(string $topic, string $aggregateType, string $aggregateId, array $payload, ?string $correlationId = null, ?string $causationId = null)
    {
